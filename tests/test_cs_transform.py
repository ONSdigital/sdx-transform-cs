...
class TestCSTransformService(unittest.TestCase):
    ...
    @patch('transform.transformers.ImageTransformer.get_image_sequence_list', return_value=[13, 14])
    ...
    @patch('transform.transformers.ImageTransformer.get_image_sequence_list', return_value=[1985, 1986])

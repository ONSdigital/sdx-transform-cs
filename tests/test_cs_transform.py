...
class TestCSTransformService(unittest.TestCase):
    ...
    @patch('transform.transformers.InMemoryImageTransformer.get_image_sequence_list', return_value=[13, 14])
    ...
    @patch('transform.transformers.InMemoryImageTransformer.get_image_sequence_list', return_value=[1985, 1986])

...
class InMemoryCSTransformer(object):
    ...
    def __init__(self, logger, survey, response_data, batch_number=False, sequence_no=1000):
        ...
        self._pck = StringIO()
        self._pck_name = ""
        self.itransformer = InMemoryImageTransformer(self._logger, self._survey, self._response,
    ...
    def create_zip(self):
        ...
        self.itransformer.zip.append(os.path.join(self.data_path, self._pck_name), self._pck.read())
    ...
    def _create_pck(self):
        ...
        self._pck_name = "%s_%04d" % (self._survey['survey_id'], self._sequence_no)
    ...
    def _create_idbr(self):
        ...
        self._idbr_name = "REC%s_%04d.DAT" % (submission_date_str, self._sequence_no)
